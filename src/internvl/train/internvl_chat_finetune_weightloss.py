...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, template_name, meta, tokenizer, tcs_loader, num_image_token,
                 ...
                 max_dynamic_patch=6, repeat_time=1, normalize_type='imagenet', base_prompt=None):
        ...
        self.extracted_words = ['right', 'left', 'center', 'upper', 'lower']
        
        
        ### test
        # data_item = json.loads(self.raw_data[0])
    ...
    def multi_modal_get_item(self, data_item):
        ...
        ret = preprocess_function(self.template_name, [deepcopy(data_item['conversations'])], self.extracted_words,
                                  self.tokenizer, self.num_image_token * num_patches,
                                  group_by_length=self.group_by_length, ds_name=self.ds_name)
        # ret = preprocess_function(self.template_name, [deepcopy(data_item['conversations'])], self.extracted_words,
        #                         self.tokenizer, self.num_image_token * num_patches,
        #                         group_by_length=self.group_by_length, ds_name='emidec_train_regt2r')
        ...
        ret = dict(
            ...
            loss_reweight=ret['loss_reweight'][0]
        )
        return ret
...
def build_datasets(data_args, tokenizer, tcs_loader, model, group_by_length=False,
    ...
    for ds_name in ds_collections.keys():
        ...
        base_prompt = ds_collections[ds_name]['base_prompt']
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        ...
        model = InternVLChatModelWeightLoss.from_pretrained(
        ...
        model = InternVLChatModelWeightLoss(internvl_chat_config, vision_model, llm)
