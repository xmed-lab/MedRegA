...
class InternVLChatModelMI(PreTrainedModel):
    ...
    def __init__(self, config: InternVLChatConfig, vision_model=None, language_model=None):
        ...
        if vision_model is not None:
            ...
            self.vision_model = InternVisionModelMI(config.vision_config)
    ...
    def multi_image_chat(self, tokenizer, pixel_values, question, generation_config, history=None,
    ...
    def chat_text(self, tokenizer, question, generation_config, history=None, return_history=False,
             IMG_START_TOKEN='<img>', IMG_END_TOKEN='</img>', IMG_CONTEXT_TOKEN='<IMG_CONTEXT>'):
        img_context_token_id = tokenizer.convert_tokens_to_ids(IMG_CONTEXT_TOKEN)
        self.img_context_token_id = img_context_token_id
        eos_token_id = tokenizer.eos_token_id
